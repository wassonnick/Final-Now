        ...
        return City::query()
            ...
            ->map(function (City $city) use ($indexingEnabled, $approvedSlugs) {
                ...
                return [
                    ...
                    'title' => $city->name.' Society-First Home Search Preview | SocietyFlats',
                    'meta_description' => 'Review-only '.$city->name.' city coverage preview for SocietyFlats. City indexing requires explicit approval, verified society depth and the NCR indexing flag.',
                    'h1' => $city->name.' society-first home search preview',
