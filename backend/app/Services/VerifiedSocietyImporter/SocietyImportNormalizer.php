...
class SocietyImportNormalizer
{
    ...
    public function societyAttributes(array $data): array
    {
        ...
        return array_filter([
            ...
            'city'=>$data['city'], 'sector'=>$data['sector'] ?: null, 'locality'=>$data['locality'] ?? null, 'address'=>$data['address'] ?? null,
