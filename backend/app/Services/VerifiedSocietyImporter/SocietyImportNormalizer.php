...
class SocietyImportNormalizer
{
    public const ALIASES = [
        ...
        'region_id' => ['region_id','region id'], 'city_id' => ['city_id','city id'], 'zone_id' => ['zone_id','zone id'],
        'locality_id' => ['locality_id','locality id'], 'micro_market' => ['micro_market','micro market'],
        'authority' => ['authority'], 'pincode' => ['pincode','pin code','postal code'],
    ];
    ...
    public function societyAttributes(array $data): array
    {
        ...
        return array_filter([
            ...
            'region_id'=>$data['region_id'] ?? null, 'city_id'=>$data['city_id'] ?? null, 'zone_id'=>$data['zone_id'] ?? null,
            'locality_id'=>$data['locality_id'] ?? null, 'micro_market'=>$data['micro_market'] ?? null,
            'authority'=>$data['authority'] ?? null, 'pincode'=>$data['pincode'] ?? null,
