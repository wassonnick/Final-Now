...
class SeoAutomationSetting extends Model
{
    protected $fillable = [
        ...
        'drafts_per_run', 'timezone', 'auto_publish_enabled', 'auto_publish_min_confidence',
    ];
    ...
    protected $casts = [
        ...
        'drafts_per_run'=>'integer', 'auto_publish_enabled'=>'boolean',
        'auto_publish_min_confidence'=>'integer',
    ];
}
