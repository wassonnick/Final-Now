    ...
    <div className="min-h-screen bg-ivory-100 pb-20 md:pb-0">
      ...
      <div className="fixed inset-x-3 bottom-3 z-50 rounded-2xl border border-navy-100 bg-white/95 px-3 py-2 shadow-[0_-10px_24px_rgba(15,23,42,0.12)] backdrop-blur md:hidden">
        <div className="grid grid-cols-3 gap-2">
          <Button
            onClick={() => openLead("callback")}
            aria-label="Request property callback"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="Open WhatsApp for this property"
          ...
          <Button
            onClick={() => openLead("enquiry")}
            aria-label="Ask details about this property"
            variant="outline"
            className="h-10 rounded-full border-blue-200 px-2 text-xs font-bold text-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-300 focus-visible:ring-offset-2"
          >
            Enquire
          </Button>
        </div>
