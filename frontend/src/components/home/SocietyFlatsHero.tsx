    ...
    <>
      <section className="border-b border-[#DDD7CC] bg-[#F7F4EF] lg:hidden">
        <div className="px-5 pb-7 pt-5">
          ...
          <p className="mt-3 text-[14px] leading-6 text-[#667085]">We score every society, check every price and put a friendly AI advisor by your side — so the search feels calm and clear.</p>
