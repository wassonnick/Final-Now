...
const groups: Array<{ heading: string | null; links: Array<{ label: string; href: string; icon: any }> }> = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Market Refresh", href: "/admin/market-refresh", icon: Bot },
      { label: "Re-harvest Images", href: "/admin/image-reharvest", icon: ImageIcon },
      { label: "Contributed Images", href: "/admin/image-contributions", icon: Camera },
